...
export const db = singleton('db', () => {
  ...
  const decade = db.user.create({
    id: '9d6eba59daa2fc2078cf8205cd458841',
    email: 'decadehew.dev.com',
    username: 'decade',
    name: 'DecadeHew',
  })
...
async function writeImage(image: File) {
  const tmpDir = path.join(process.cwd(), 'public', 'images')
